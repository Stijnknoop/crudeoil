...
* **Pure Combination Trade Yield (Rauw Totaal):** 0.3780%
* **Net Portfolio Session Yield (1x Base Portfolio):** 0.0945%
* **Net Portfolio Session Yield (10x Leveraged Portfolio):** **0.9451%**
* **Average Yield per Executed Slot (1x Base Portfolio):** 0.0189%
* **Average Yield per Executed Slot (10x Leveraged Portfolio):** 0.1890%
